...
app.get("/health", (req, res) => {
  res.status(200).json({
    success: true,
    message: "Kaynela Farms Booking Service is healthy",
...
async function startServer() {
  try {
    logger.info("🚀 Starting Kaynela Farms Booking Service...");
    ...
    server = app.listen(PORT, () => {
      isServiceReady = true;
      logger.info(
        `✅ Kaynela Farms Booking Service fully operational on port ${PORT}`
      );
