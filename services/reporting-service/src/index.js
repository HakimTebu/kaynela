...
app.get("/health", (req, res) => {
  res.status(200).json({
    success: true,
    message: "Kaynela Farms Reporting Service is healthy",
...
async function startServer() {
  try {
    logger.info("🚀 Starting Kaynela Farms Reporting Service...");
    ...
    server = app.listen(PORT, () => {
      isServiceReady = true;
      logger.info(
        `✅ Kaynela Farms Reporting Service fully operational on port ${PORT}`
      );
