...
app.get("/health", (req, res) => {
  res.status(200).json({
    success: true,
    message: "Kaynela Farms Payment Service is healthy",
...
async function startServer() {
  try {
    logger.info("🚀 Starting Kaynela Farms Payment Service...");
    ...
    server = app.listen(PORT, () => {
      isServiceReady = true;
      logger.info(
        `✅ Kaynela Farms Payment Service fully operational on port ${PORT}`
      );
